...
$sql = "SELECT categorie, reference, designation, tutelle, contrat, bon_commande, vendeur, marque, date_achat, responsable_achat, garantie, prix, sortie, raison_sortie FROM base WHERE base_index = ?;";
$sth = $dbh->prepare($sql);
$sth->execute([$copyid]);
