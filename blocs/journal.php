...
if ( empty($historique) ) echo "Aucune intervention spécifiée.";
    ...
    foreach ($historique as $h) {
        ...
        if ($write) echo "<span id=\"linkbox\" onclick=\"TINY.box.show({url:'_del_confirm.php?i=$i&h=".$h[0]."',width:280,height:110})\" title=\"supprimer cette entrée (".$h[0].") du journal\">×</span>";
        else echo "&nbsp;";
        echo "</td>";
        echo "</tr>";
    }
