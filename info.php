...
/* Intégration de choosen*/
echo "<script src=\"chosen/jquery.min.js\" type=\"text/javascript\"></script>";
echo "<script src=\"chosen/chosen.jquery.js\" type=\"text/javascript\"></script>";
