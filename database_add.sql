...
CREATE TABLE `base` (
  ...
  `localisation` int(11) NOT NULL DEFAULT '0',
  `date_localisation` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Date à laquelle la localisation à été renseignée (rempli automatiquement)',
  `tutelle` int(11) NOT NULL DEFAULT '0',
  `contrat` int(11) NOT NULL DEFAULT '0',
  `bon_commande` text ,
  ...
  `responsable_achat` int(11) NOT NULL DEFAULT '0',
  `garantie` date NOT NULL DEFAULT '0000-00-00' COMMENT 'date de fin de garantie',
  `prix` decimal(11,0) ,
  `date_sortie` date NOT NULL DEFAULT '0000-00-00' COMMENT 'date à laquelle le produit est sortie de base de données',
  `sortie` tinyint(1) DEFAULT '0' COMMENT '0 pour non sortie 1 pour sortie définitive 2 pour sortie temporaire',
  `raison_sortie` int(11) DEFAULT '0',
  `integration` int(11) NOT NULL DEFAULT '0' COMMENT 'Si le composant est intégré dans un ensemble qui est répertorié'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
