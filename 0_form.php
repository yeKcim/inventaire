...
#                        IOT : in/out/tmp                               #
#########################################################################
//selecteur_selectwo("IOT", $iot, "— Répertorié (sauf sorti déf.) —", "iot_index", "iot_nom");
$iot=array();
...
echo "<select name=\"IOT\" onchange=\"submit();\" data-placeholder=\"Choose…\" class=\"select2\" tabindex=\"0\" id=\"iot\">";
foreach ($iot as $i) {
...
selecteur_selectwo("TYC", $types_contrats, "Tous types de contrat", "contrat_type_index", "contrat_type_cat");
